#ifndef __TERRITORY_DATA_EXTRACTOR_H__
#define __TERRITORY_DATA_EXTRACTOR_H__
...
class TerritoryDataExtractor : public DataExtractor
{
public:
    TerritoryDataExtractor(const std::string& targetDir, int numGames)
...
#endif // __TERRITORY_DATA_EXTRACTOR_H__
